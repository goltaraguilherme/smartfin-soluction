...
export default function Dashboard() {
  ...
  const initialFilterData = storedFilterData ? JSON.parse(storedFilterData) : {
    pvp: "",
    dividendos: "",
    vacanciaFisica: "",
    vacanciaFinanceira: "",
            ...
            <form action="" className="w-100">
              <label className="text-gray-400 py-4" htmlFor="">
                ...
                <input  onChange={(e) =>
                  ...
                  } className="w-[20vw] mt-2 p-2 outline-none border-0 bg-gray-600 text-white" type="number" placeholder="Ex.: 1"/>
              </label>
              ...
              <label className="text-gray-400 py-2" htmlFor="">
                ...
                } className="w-[20vw] mt-2 p-2 outline-none border-0 bg-gray-600 text-white" type="text" placeholder="Exemplo: 0,8%/mês"/>
              </label>
              ...
              <label className="text-gray-400 py-2" htmlFor="">
                ...
                className="w-[20vw] mt-2 p-2 outline-none border-0 bg-gray-600 text-white" type="number" placeholder="Ex.: 10%"/>
              </label>
